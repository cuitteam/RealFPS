...
int (*orig_eglSwapBuffers)(EGLDisplay dpy, EGLSurface surf);

int hooked_egl(EGLDisplay dpy, EGLSurface surf)
{
	LOGI("eglSwapBuffers is invoked...\n");
...
void hook_entry(char* a)
{
	...
	orig_eglSwapBuffers = do_hook(module_path, hooked_egl, sym);
